...
for(let fd of dcsFolders)
{
    ...
    fs.cpSync('./dcs/WebUFC', wufcfolder, {recursive:true});
    fs.copyFileSync('./dcs/WebUFC.lua', wufcfile);
...
if(success)
{
    console.log('Export scripts succesfully installed')
}
else
{
    console.log('Failed to find Save games folder, please install export scripts manually')
}